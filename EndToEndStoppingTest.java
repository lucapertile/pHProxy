...
public class EndToEndStoppingTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        HttpProxyServer proxyServer = DefaultHttpProxyServer.bootstrap()
                /*.withSslEngineSource(new SelfSignedSslEngineSource("",true,true)).*/.withManInTheMiddle(new SelfSignedMitmManager()).withPort(port).withFiltersSource(new HttpFiltersSourceAdapter() {
                    public HttpFilters filterRequest(HttpRequest originalRequest, ChannelHandlerContext ctx) {
                        return new HttpFiltersAdapter(originalRequest) {
                            @Override
                            public io.netty.handler.codec.http.HttpResponse requestPre(HttpObject httpObject) {
                                // TODO: implement your filtering here
                                return null;
                            }

                            @Override
                            public io.netty.handler.codec.http.HttpResponse requestPost(HttpObject httpObject) {
                                // TODO: implement your filtering here
                                return null;
                            }
